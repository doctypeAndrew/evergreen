...
export function updateData() {
  const bannerPhotoElem = document.querySelector('.banner-home-bg-image');
  const bannerGraphicElem = document.querySelector('.banner-home-graphic');

  let bannerPhotoSize = getBackgroundSize(bannerPhotoElem);
  let bannerPhotoHeight = Math.round(bannerPhotoSize.height);
  let pxPosition = bannerPhotoHeight - bannerGraphicElem.height;

  bannerGraphicElem.style.top = pxPosition + 'px';
}
